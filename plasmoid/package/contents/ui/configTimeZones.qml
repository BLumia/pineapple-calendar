...
ColumnLayout {
    ...
    QQC2.ScrollView {
        ...
        ListView {
            ...
            delegate: Kirigami.BasicListItem {
                ...
                label: model.city
                subtitle: isCurrent && configuredTimezoneList.count > 1 ? i18nd("plasma_applet_org.kde.plasma.digitalclock", "Clock is currently using this time zone") : ""
                ...
                trailing: RowLayout {
                    QQC2.Button {
                        ...
                        text: i18nd("plasma_applet_org.kde.plasma.digitalclock", "Switch Local Time Zone…")
            ...
            section {
                ...
                delegate: Kirigami.ListSectionHeader {
                    label: section == "true" ? i18nd("plasma_applet_org.kde.plasma.digitalclock", "System's Local Time Zone") : i18nd("plasma_applet_org.kde.plasma.digitalclock", "Additional Time Zones")
                }
            }
    ...
    QQC2.Button {
        ...
        text: i18nd("plasma_applet_org.kde.plasma.digitalclock", "Add Time Zones…")
        icon.name: "list-add"
    ...
    QQC2.Label {
        ...
        text: i18nd("plasma_applet_org.kde.plasma.digitalclock", "Note that using a different time zone for the clock does not change the systemwide local time zone. When you travel, switch the local time zone instead.")
    ...
    Kirigami.OverlaySheet {
        ...
        header: ColumnLayout {
            ...
            Kirigami.Heading {
                Layout.fillWidth: true
                text: i18nd("plasma_applet_org.kde.plasma.digitalclock", "Add More Timezones")
                wrapMode: Text.Wrap
            }
